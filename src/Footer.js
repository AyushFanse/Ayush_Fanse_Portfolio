...
=======
            <Grid id="footerOut">
                <ul>
                    ...
                    <li>
                        <div>
                            <a className="links" rel="noreferrer" download="download" href="https://drive.google.com/file/d/1rW6F8zuv4EoSTcyvt_3hcY2wXfrN_X9e/view?usp=sharing" target="_blank">
                                <ArticleIcon id="icons"/>
                            </a>
                        </div>
                        <h6 id="FooterName">
