                    ...
                    <Grid id="Contact_Footer">
                        <Box id="Contact_footerBody" className="cursor">
                            ...
                            <ul>
                                ...
                                <li data-aos="slide-right">
                                    <div>
                                        <a className="links hover" rel="noreferrer" download="download" href="https://drive.google.com/file/d/19X0s6QQkIzjycXVlmABqpwRi3K6RfSa9/view?usp=sharing" target="_blank">
