...
function Contact__(props) {
    ...
    const sendEmail = (e) => {
        ...
        if(contactForm.current.name.value && contactForm.current.email.value && contactForm.current.message.value ){
            ...
            emailjs.sendForm('service_21upo2n', 'template_f9gconr', contactForm.current, 'iv9_I_A-Kmup-VXS3')
            .then((result) => {
        ...
        <>
            <Box>
                ...
                <form  ref={contactForm} onSubmit={sendEmail}>
                    ...
                    <textarea className='textArea' id="message" rows="7" name="message" placeholder="Write your message..."/>
